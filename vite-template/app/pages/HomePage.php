...
$homePage = new Component(fn() => <<<HTML
    <div class="mx-auto max-w-6xl space-y-20 text-left">
        <section class="relative overflow-hidden rounded-4xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-10 shadow-[0_0_120px_rgba(59,130,246,0.25)]">
   ...
   \$counter(\$counter() + 1);
        ...
        <section class="grid gap-8 lg:grid-cols-3">
            ...
            <article class="card">
                ...
                <ul class="mt-6 space-y-2 text-sm text-slate-200">
                    <li>• useState()/useEffect() helpers shared in PHP components</li>
                    <li>• phpspa.on('beforeload'|'load') for runtime events</li>
        ...
        <section class="rounded-4xl border border-white/10 bg-gradient-to-r from-indigo-500/80 via-sky-500/70 to-cyan-400/70 p-10 text-slate-900">
